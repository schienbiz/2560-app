...
const SECTIONS = [
  ...
  },
  {
    title: "回測",
    content: `
      <p>在圖表頁點擊 <strong>📊 回測</strong>，以近 1 年歷史資料模擬交叉訊號的實際績效。</p>
      <table>
        <tr><th>欄位</th><th>說明</th></tr>
        <tr><td>已結清</td><td>已出場的模擬交易筆數</td></tr>
        <tr><td>勝率</td><td>獲利筆數 ÷ 已結清總筆數</td></tr>
        <tr><td>平均報酬</td><td>每筆已結清交易的平均漲跌幅</td></tr>
        <tr><td>最佳 / 最差</td><td>單筆最高獲利 / 最大虧損</td></tr>
        <tr><td>持倉中</td><td>最後一筆未出場，顯示目前未實現損益</td></tr>
      </table>
      <p style="color:var(--muted);font-size:0.85rem">回測為事後統計，不代表未來績效。滑點與手續費未納入計算。</p>
    `,
  },
  {
    title: "提醒",
